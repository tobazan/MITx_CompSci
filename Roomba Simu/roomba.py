...
class RectangularRoom(object):
    ...
    def getRandomPosition(self):
        ...
        """
        random_pos = Position(random.randint(0, self.width-1), random.randint(0, self.height-1))
    ...
    def isPositionInRoom(self, pos):
        ...
        if math.floor(pos.getX()) <= self.width-1 and math.floor(pos.getY()) <= self.height-1:
            return True
